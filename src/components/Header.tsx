...
import { Mic2, Radio, Sparkles, Volume2, Key } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ customApiKey, onOpenApiKeyModal }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 text-xs text-slate-400">
          ...
          <button
            ...
            title="Configurar clave API de Google Gemini"
          >
            <Key className="w-3.5 h-3.5 text-amber-400" />
            <span>{customApiKey ? 'Clave Activa' : 'Configurar Clave API'}</span>
          </button>
          ...
          <div className="hidden lg:flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white/5 border border-white/10 text-slate-300 font-medium">
